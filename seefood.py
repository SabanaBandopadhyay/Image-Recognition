...
def add_text_to_img(img, text, pos=(0, 0), color=(0, 0, 0), bgcolor=(255, 255, 255, 128),
                    columns=60,
                    font=ImageFont.truetype('/Library/Fonts/Arial Unicode.ttf', 22)):
    '''
...
def label_image(img, confidence=50):
    ...
    for label in rekresp['Labels']:
        ...
        if label['Name'] == "Hot Dog":
            imgtext = label['Name']
        elif label['Name'] == "Food":
            imgtext1 = 'Food'
        #print()

    pilimg = get_pillow_img(imgbytes)
    #pprint(pilimg)

    if imgtext == "Hot Dog":
        textposition = (300,200)
        textcolor =(255,255,255 )
        textbgcolor = (51, 255, 79, 255)
    else :
        textposition = (220, 650)
        textcolor = (255, 255, 255)
        textbgcolor = (255, 51, 66 , 255)
    #pprint(pilimg)

    #print(imgtext)

    if imgtext1 == "Food" and imgtext == "Hot Dog":
        textposition1 = (300, 230)
        textcolor1 = (255, 255, 255)
        textbgcolor1 = (51, 255, 79, 255)
    else:
        textposition1 = (220, 680)
        textcolor1 = (255, 255, 255)
        textbgcolor1 = (255, 51, 66, 255)


    pilimg = add_text_to_img(pilimg , imgtext , pos=textposition , color = textcolor , bgcolor=textbgcolor)
    pilimgfinal = add_text_to_img(pilimg, imgtext1, pos=textposition1, color=textcolor1, bgcolor=textbgcolor1)
